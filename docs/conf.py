...
sys.path.insert(0, os.path.abspath(".."))  # ruff: ignore[os-path-abspath]
...
def delete_doc_for_address_base() -> None:
    ...
    from mcstatus._net.address import _AddressBase  # ruff: ignore[import-outside-top-level, import-private-name]  # pyright: ignore[reportPrivateUsage]
