...
class TestServerPinger:
    ...
    def test_read_status(self):
        self.pinger.connection.receive(
            bytearray.fromhex(
                "7200707B226465736372697074696F6E223A2241204D696E65637261667420536572766572222C22706C6179657273223A7B226D61782"
                + "23A32302C226F6E6C696E65223A307D2C2276657273696F6E223A7B226E616D65223A22312E382D70726531222C2270726F746F636F"
                + "6C223A34347D7D"
            )
        )
    ...
    def test_read_status_invalid_reply(self):
        self.pinger.connection.receive(
            ...
            bytearray.fromhex(
                "4F004D7B22706C6179657273223A7B226D6178223A32302C226F6E6C696E65223A307D2C2276657273696F6E223A7B226E616D65223A2"
                + "2312E382D70726531222C2270726F746F636F6C223A34347D7D"
            )
        )
    ...
    def test_latency_is_real_number(self):
        ...
        with mock.patch.object(Connection, "read_buffer") as mocked:
            ...
            pinger.connection.receive(
                bytearray.fromhex(
                    "7200707B226465736372697074696F6E223A2241204D696E65637261667420536572766572222C22706C6179657273223A7B226D6"
                    + "178223A32302C226F6E6C696E65223A307D2C2276657273696F6E223A7B226E616D65223A22312E382D70726531222C2270726F"
                    + "746F636F6C223A34347D7D"
                )
            )
