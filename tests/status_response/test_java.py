    ...
    EXPECTED_VALUES = [
        ...
        (
            ...
            [
                ...
                ForgeDataMod(modid="cyclopscore", modmarker="1.15.1"),
                ForgeDataMod(modid="auudio", modmarker="1.0.3"),
                ForgeDataMod(modid="auxiliaryblocks", modmarker="1.18.2-0.0.14"),
                ForgeDataMod(modid="supermartijn642configlib", modmarker="1.1.6"),
                ForgeDataMod(modid="alexsmobs", modmarker="1.18.6"),
                ForgeDataMod(modid="architects_palette", modmarker="1.1.2"),
                ForgeDataMod(modid="cagerium", modmarker="1.18.2-1.1.0"),
                ForgeDataMod(modid="mcwwindows", modmarker="2.0.3"),
                ForgeDataMod(
                    modid="sophisticatedcore",
                    modmarker="1.18.2-0.5.32.179",
                ),
                ForgeDataMod(modid="thermal", modmarker="1.6.3.28"),
                ForgeDataMod(modid="rftoolsbase", modmarker="1.18-3.0.9"),
                ForgeDataMod(modid="initialinventory", modmarker="6.0.8"),
                ForgeDataMod(modid="irongenerators", modmarker="2.0.1"),
                ForgeDataMod(modid="xaeroworldmap", modmarker="1.25.1"),
                ForgeDataMod(modid="cookingforblockheads", modmarker="12.0.2"),
                ForgeDataMod(
                    modid="controlling",
                    modmarker="<not required for client>",
                ),
                ForgeDataMod(modid="xnet", modmarker="1.18-4.0.5"),
                ForgeDataMod(modid="placebo", modmarker="6.4.1"),
                ForgeDataMod(modid="citadel", modmarker="1.11.3"),
                ForgeDataMod(modid="powah", modmarker="3.0.1-beta"),
                ForgeDataMod(modid="bookshelf", modmarker="13.2.50"),
                ForgeDataMod(modid="lootbeams", modmarker="1.18.1"),
                ForgeDataMod(
                    modid="sophisticatedbackpacks",
                    modmarker="1.18.2-3.18.35.752",
                ),
                ForgeDataMod(modid="twigs", modmarker="1.1.4-patch1+1.18.2"),
                ForgeDataMod(
                    modid="buildinggadgets",
                    modmarker="3.13.0-build.5+mc1.18.2}",
                ),
                ForgeDataMod(modid="darkutils", modmarker="10.0.5"),
                ForgeDataMod(modid="mcwdoors", modmarker="1.0.6"),
                ForgeDataMod(modid="waddles", modmarker="1.18.2-0.8.19"),
                ForgeDataMod(modid="mekanismgenerators", modmarker="10.2.5"),
                ForgeDataMod(modid="balm", modmarker="3.2.0+0"),
                ForgeDataMod(modid="waila", modmarker="<not required for client>"),
                ForgeDataMod(modid="jeresources", modmarker="0.14.1.171"),
                ForgeDataMod(
                    modid="cloth_config",
                    modmarker="<not required for client>",
                ),
                ForgeDataMod(modid="shetiphiancore", modmarker="3.10.10"),
                ForgeDataMod(modid="dummmmmmy", modmarker="1.18-1.5.2"),
                ForgeDataMod(modid="supplementaries", modmarker="1.18.2-1.5.13"),
                ForgeDataMod(modid="refinedstorage", modmarker="1.10.2"),
                ForgeDataMod(modid="konkrete", modmarker="1.3.3"),
                ForgeDataMod(modid="easy_piglins", modmarker="1.18.2-1.0.0"),
                ForgeDataMod(modid="corpse", modmarker="1.18.2-1.0.2"),
                ForgeDataMod(modid="packmenu", modmarker="<not required for client>"),
                ForgeDataMod(modid="mcwbridges", modmarker="2.0.3"),
                ForgeDataMod(modid="torchmaster", modmarker="18.1.0"),
                ForgeDataMod(modid="compressium", modmarker="1.4.2-build.9+mc1.18.2"),
                ForgeDataMod(modid="ping", modmarker="1.18-1.8.0"),
                ForgeDataMod(modid="ironfurnaces", modmarker="3.3.1"),
                ForgeDataMod(modid="mcwtrpdoors", modmarker="1.0.6"),
                ForgeDataMod(modid="mcwfences", modmarker="1.0.5"),
                ForgeDataMod(modid="supermartijn642corelib", modmarker="1.0.19"),
                ForgeDataMod(modid="simplylight", modmarker="1.18.2-1.4.2-build.31"),
                ForgeDataMod(modid="botania", modmarker="1.18.2-434"),
                ForgeDataMod(modid="highlighter", modmarker="ANY"),
                ForgeDataMod(modid="spark", modmarker="<not required for client>"),
                ForgeDataMod(modid="curios", modmarker="1.18.2-5.0.7.1"),
                ForgeDataMod(modid="patchouli", modmarker="1.18.2-71.1"),
                ForgeDataMod(modid="camera", modmarker="1.18.2-1.0.4"),
                ForgeDataMod(modid="blockcarpentry", modmarker="1.18-0.3.0"),
                ForgeDataMod(modid="thermal_foundation", modmarker="1.6.3.28"),
                ForgeDataMod(modid="thermal_expansion", modmarker="1.6.3.13"),
                ForgeDataMod(modid="libnonymous", modmarker="2.1.0"),
                ForgeDataMod(modid="elevatorid", modmarker="1.18.2-1.8.4"),
                ForgeDataMod(modid="runelic", modmarker="11.0.1"),
                ForgeDataMod(
                    modid="worldedit",
                    modmarker="<not required for client>",
                ),
                ForgeDataMod(modid="cfm", modmarker="7.0.0-pre29"),
                ForgeDataMod(modid="architectury", modmarker="4.9.84"),
                ForgeDataMod(modid="weirdinggadget", modmarker="2.2.11"),
                ForgeDataMod(modid="mcwfurnitures", modmarker="3.0.0"),
                ForgeDataMod(modid="trashcans", modmarker="1.0.15"),
                ForgeDataMod(modid="mcwlights", modmarker="1.0.3"),
                ForgeDataMod(modid="cucumber", modmarker="5.1.2"),
                ForgeDataMod(modid="snad", modmarker="1.18.2-1.22.04.15a"),
                ForgeDataMod(modid="jei", modmarker="9.7.0.209"),
                ForgeDataMod(modid="ae2", modmarker="11.1.4"),
                ForgeDataMod(modid="mekanism", modmarker="10.2.5"),
                ForgeDataMod(modid="bdlib", modmarker="1.19.3.7"),
                ForgeDataMod(modid="create", modmarker="0.5.0.d"),
                ForgeDataMod(modid="waystones", modmarker="10.1.0"),
                ForgeDataMod(modid="clumps", modmarker="8.0.0+10"),
                ForgeDataMod(modid="shutupexperimentalsettings", modmarker="1.0.5"),
                ForgeDataMod(modid="comforts", modmarker="1.18.2-5.0.0.4"),
                ForgeDataMod(modid="naturescompass", modmarker="1.18.2-1.9.7-forge"),
                ForgeDataMod(modid="storagenetwork", modmarker="1.18.2-1.6.1"),
                ForgeDataMod(modid="framedcompactdrawers", modmarker="1.18-4.1.0"),
                ForgeDataMod(modid="decorative_blocks", modmarker="2.1.0"),
                ForgeDataMod(modid="botanypots", modmarker="8.0.12"),
                ForgeDataMod(modid="ftbbackups2", modmarker="1.0.17"),
                ForgeDataMod(modid="cofh_core", modmarker="1.6.4.21"),
                ForgeDataMod(modid="mcjtylib", modmarker="1.18-6.0.15"),
                ForgeDataMod(modid="ispawner", modmarker="1.0"),
                ForgeDataMod(modid="everycomp", modmarker="1.18.2-1.5.7"),
                ForgeDataMod(modid="jeitweaker", modmarker="3.0.0.8"),
                ForgeDataMod(modid="terralith", modmarker="0.0NONE"),
                ForgeDataMod(modid="mininggadgets", modmarker="1.11.0"),
                ForgeDataMod(modid="crafttweaker", modmarker="9.1.197"),
                ForgeDataMod(modid="akashictome", modmarker="1.5-20"),
                ForgeDataMod(modid="forge", modmarker="ANY"),
                ForgeDataMod(modid="colossalchests", modmarker="1.8.3"),
                ForgeDataMod(modid="selene", modmarker="1.18.2-1.17.9"),
                ForgeDataMod(modid="drippyloadingscreen", modmarker="1.6.4"),
                ForgeDataMod(
                    modid="craftingtweaks",
                    modmarker="<not required for client>",
                ),
                ForgeDataMod(modid="minecraft", modmarker="1.18.2"),
                ForgeDataMod(modid="terrablender", modmarker="1.18.2-1.1.0.102"),
                ForgeDataMod(
                    modid="sophisticatedbackpacksvh",
                    modmarker="1.18.2-1.0.4.12",
                ),
                ForgeDataMod(modid="mousetweaks", modmarker="ANY"),
                ForgeDataMod(modid="titanium", modmarker="3.5.6"),
                ForgeDataMod(modid="jade", modmarker="<not required for client>"),
                ForgeDataMod(modid="createtweaker", modmarker="2.0.0.17"),
                ForgeDataMod(modid="easy_villagers", modmarker="1.18.2-1.0.10"),
                ForgeDataMod(modid="pipez", modmarker="1.18.2-1.1.5"),
                ForgeDataMod(modid="iceberg", modmarker="ANY"),
                ForgeDataMod(modid="flywheel", modmarker="<not required for client>"),
                ForgeDataMod(modid="mantle", modmarker="1.9.27"),
                ForgeDataMod(modid="ecologics", modmarker="1.7.3"),
                ForgeDataMod(modid="quark", modmarker="3.2-358"),
                ForgeDataMod(modid="xaerominimap", modmarker="22.11.1"),
                ForgeDataMod(modid="pigpen", modmarker="8.0.1"),
                ForgeDataMod(modid="fastbench", modmarker="6.0.2"),
                ForgeDataMod(modid="polymorph", modmarker="1.18.2-0.44"),
                ForgeDataMod(modid="autoreglib", modmarker="1.7-53"),
                ForgeDataMod(modid="storagedrawers", modmarker="10.2.1"),
                ForgeDataMod(modid="fluxnetworks", modmarker="7.0.7.8"),
                ForgeDataMod(modid="neoncraft2", modmarker="2.2"),
                ForgeDataMod(modid="enercell", modmarker="0.0NONE"),
                ForgeDataMod(modid="appleskin", modmarker="2.4.0+mc1.18"),
                ForgeDataMod(
                    modid="ferritecore",
                    modmarker="<not required for client>",
                ),
                ForgeDataMod(modid="modularrouters", modmarker="9.1.1-93"),
                ForgeDataMod(modid="refinedstorageaddons", modmarker="0.8.2"),
                ForgeDataMod(modid="openloader", modmarker="12.0.1"),
                ForgeDataMod(modid="the_vault", modmarker="1.18.2-2.0.10.869"),
            ],
        ),
        ("truncated", False),
    ]
