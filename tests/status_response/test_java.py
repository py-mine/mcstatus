    ...
    EXPECTED_VALUES = [
        ...
        (
            ...
            [
                ...
                ForgeDataChannel(res="xnet:xnet", version="1.0", required=True),
                ForgeDataChannel(
                    res="placebo:placebo",
                    version="1.0.0",
                    required=True,
                ...
                ForgeDataChannel(res="corpse:default", version="1.0.0", required=True),
                ForgeDataChannel(
                ...
                ForgeDataChannel(res="botania:main", version="0", required=False),
                ForgeDataChannel(res="curios:main", version="1", required=False),
                ForgeDataChannel(res="patchouli:main", version="1", required=False),
                ForgeDataChannel(res="camera:default", version="1.0.0", required=True),
                ForgeDataChannel(
                ...
                ForgeDataChannel(res="worldedit:cui", version="1", required=True),
                ForgeDataChannel(res="worldedit:internal", version="1", required=True),
                ForgeDataChannel(res="cfm:network", version="1", required=False),
                ForgeDataChannel(
                    res="architectury:network",
                    version="1",
                    required=True,
                ),
                ForgeDataChannel(res="trashcans:main", version="1", required=False),
                ForgeDataChannel(res="jei:channel", version="1.0.0", required=True),
                ForgeDataChannel(res="ae2:main", version="1", required=True),
                ForgeDataChannel(
                    res="mekanism:mekanism",
                    version="10.2.5",
                    required=False,
                ),
                ForgeDataChannel(res="bdlib:multiblock", version="2", required=False),
                ForgeDataChannel(res="bdlib:misc", version="1", required=False),
                ForgeDataChannel(res="create:main", version="1", required=False),
                ForgeDataChannel(
                    res="waystones:network",
                    version="1.0",
                    required=False,
                ),
                ForgeDataChannel(res="comforts:main", version="1", required=False),
                ForgeDataChannel(
                ...
                ForgeDataChannel(res="cofh_core:general", version="1", required=True),
                ForgeDataChannel(
                ...
                ForgeDataChannel(res="akashictome:main", version="1", required=False),
                ForgeDataChannel(
                ...
                ForgeDataChannel(res="selene:network", version="1", required=False),
                ForgeDataChannel(
                ...
                ForgeDataChannel(res="titanium:network", version="1.0", required=True),
                ForgeDataChannel(
                    res="easy_villagers:default",
                    version="1.0.0",
                    required=True,
                ),
                ForgeDataChannel(res="pipez:default", version="1.0.0", required=True),
                ForgeDataChannel(res="mantle:network", version="1", required=False),
                ForgeDataChannel(res="quark:main", version="1", required=False),
                ForgeDataChannel(
                ...
                ForgeDataChannel(res="polymorph:main", version="1", required=False),
                ForgeDataChannel(
                ...
                ForgeDataChannel(res="appleskin:sync", version="1", required=True),
                ForgeDataChannel(
        ...
        (
            "mods",
            [
                ForgeDataMod(mod_id="rsrequestify", mod_version="2.2.0"),
                ForgeDataMod(mod_id="cyclopscore", mod_version="1.15.1"),
                ForgeDataMod(mod_id="auudio", mod_version="1.0.3"),
                ForgeDataMod(mod_id="auxiliaryblocks", mod_version="1.18.2-0.0.14"),
                ForgeDataMod(mod_id="supermartijn642configlib", mod_version="1.1.6"),
                ForgeDataMod(mod_id="alexsmobs", mod_version="1.18.6"),
                ForgeDataMod(mod_id="architects_palette", mod_version="1.1.2"),
                ForgeDataMod(mod_id="cagerium", mod_version="1.18.2-1.1.0"),
                ForgeDataMod(mod_id="mcwwindows", mod_version="2.0.3"),
                ForgeDataMod(
                    mod_id="sophisticatedcore",
                    mod_version="1.18.2-0.5.32.179",
                ),
                ForgeDataMod(mod_id="thermal", mod_version="1.6.3.28"),
                ForgeDataMod(mod_id="rftoolsbase", mod_version="1.18-3.0.9"),
                ForgeDataMod(mod_id="initialinventory", mod_version="6.0.8"),
                ForgeDataMod(mod_id="irongenerators", mod_version="2.0.1"),
                ForgeDataMod(mod_id="xaeroworldmap", mod_version="1.25.1"),
                ForgeDataMod(mod_id="cookingforblockheads", mod_version="12.0.2"),
                ForgeDataMod(
                    mod_id="controlling",
                    mod_version="<not required for client>",
                ),
                ForgeDataMod(mod_id="xnet", mod_version="1.18-4.0.5"),
                ForgeDataMod(mod_id="placebo", mod_version="6.4.1"),
                ForgeDataMod(mod_id="citadel", mod_version="1.11.3"),
                ForgeDataMod(mod_id="powah", mod_version="3.0.1-beta"),
                ForgeDataMod(mod_id="bookshelf", mod_version="13.2.50"),
                ForgeDataMod(mod_id="lootbeams", mod_version="1.18.1"),
                ForgeDataMod(
                    mod_id="sophisticatedbackpacks",
                    mod_version="1.18.2-3.18.35.752",
                ),
                ForgeDataMod(mod_id="twigs", mod_version="1.1.4-patch1+1.18.2"),
                ForgeDataMod(
                    mod_id="buildinggadgets",
                    mod_version="3.13.0-build.5+mc1.18.2}",
                ),
                ForgeDataMod(mod_id="darkutils", mod_version="10.0.5"),
                ForgeDataMod(mod_id="mcwdoors", mod_version="1.0.6"),
                ForgeDataMod(mod_id="waddles", mod_version="1.18.2-0.8.19"),
                ForgeDataMod(mod_id="mekanismgenerators", mod_version="10.2.5"),
                ForgeDataMod(mod_id="balm", mod_version="3.2.0+0"),
                ForgeDataMod(mod_id="waila", mod_version="<not required for client>"),
                ForgeDataMod(mod_id="jeresources", mod_version="0.14.1.171"),
                ForgeDataMod(
                    mod_id="cloth_config",
                    mod_version="<not required for client>",
                ),
                ForgeDataMod(mod_id="shetiphiancore", mod_version="3.10.10"),
                ForgeDataMod(mod_id="dummmmmmy", mod_version="1.18-1.5.2"),
                ForgeDataMod(mod_id="supplementaries", mod_version="1.18.2-1.5.13"),
                ForgeDataMod(mod_id="refinedstorage", mod_version="1.10.2"),
                ForgeDataMod(mod_id="konkrete", mod_version="1.3.3"),
                ForgeDataMod(mod_id="easy_piglins", mod_version="1.18.2-1.0.0"),
                ForgeDataMod(mod_id="corpse", mod_version="1.18.2-1.0.2"),
                ForgeDataMod(mod_id="packmenu", mod_version="<not required for client>"),
                ForgeDataMod(mod_id="mcwbridges", mod_version="2.0.3"),
                ForgeDataMod(mod_id="torchmaster", mod_version="18.1.0"),
                ForgeDataMod(mod_id="compressium", mod_version="1.4.2-build.9+mc1.18.2"),
                ForgeDataMod(mod_id="ping", mod_version="1.18-1.8.0"),
                ForgeDataMod(mod_id="ironfurnaces", mod_version="3.3.1"),
                ForgeDataMod(mod_id="mcwtrpdoors", mod_version="1.0.6"),
                ForgeDataMod(mod_id="mcwfences", mod_version="1.0.5"),
                ForgeDataMod(mod_id="supermartijn642corelib", mod_version="1.0.19"),
                ForgeDataMod(mod_id="simplylight", mod_version="1.18.2-1.4.2-build.31"),
                ForgeDataMod(mod_id="botania", mod_version="1.18.2-434"),
                ForgeDataMod(mod_id="highlighter", mod_version="ANY"),
                ForgeDataMod(mod_id="spark", mod_version="<not required for client>"),
                ForgeDataMod(mod_id="curios", mod_version="1.18.2-5.0.7.1"),
                ForgeDataMod(mod_id="patchouli", mod_version="1.18.2-71.1"),
                ForgeDataMod(mod_id="camera", mod_version="1.18.2-1.0.4"),
                ForgeDataMod(mod_id="blockcarpentry", mod_version="1.18-0.3.0"),
                ForgeDataMod(mod_id="thermal_foundation", mod_version="1.6.3.28"),
                ForgeDataMod(mod_id="thermal_expansion", mod_version="1.6.3.13"),
                ForgeDataMod(mod_id="libnonymous", mod_version="2.1.0"),
                ForgeDataMod(mod_id="elevatorid", mod_version="1.18.2-1.8.4"),
                ForgeDataMod(mod_id="runelic", mod_version="11.0.1"),
                ForgeDataMod(
                    mod_id="worldedit",
                    mod_version="<not required for client>",
                ),
                ForgeDataMod(mod_id="cfm", mod_version="7.0.0-pre29"),
                ForgeDataMod(mod_id="architectury", mod_version="4.9.84"),
                ForgeDataMod(mod_id="weirdinggadget", mod_version="2.2.11"),
                ForgeDataMod(mod_id="mcwfurnitures", mod_version="3.0.0"),
                ForgeDataMod(mod_id="trashcans", mod_version="1.0.15"),
                ForgeDataMod(mod_id="mcwlights", mod_version="1.0.3"),
                ForgeDataMod(mod_id="cucumber", mod_version="5.1.2"),
                ForgeDataMod(mod_id="snad", mod_version="1.18.2-1.22.04.15a"),
                ForgeDataMod(mod_id="jei", mod_version="9.7.0.209"),
                ForgeDataMod(mod_id="ae2", mod_version="11.1.4"),
                ForgeDataMod(mod_id="mekanism", mod_version="10.2.5"),
                ForgeDataMod(mod_id="bdlib", mod_version="1.19.3.7"),
                ForgeDataMod(mod_id="create", mod_version="0.5.0.d"),
                ForgeDataMod(mod_id="waystones", mod_version="10.1.0"),
                ForgeDataMod(mod_id="clumps", mod_version="8.0.0+10"),
                ForgeDataMod(mod_id="shutupexperimentalsettings", mod_version="1.0.5"),
                ForgeDataMod(mod_id="comforts", mod_version="1.18.2-5.0.0.4"),
                ForgeDataMod(mod_id="naturescompass", mod_version="1.18.2-1.9.7-forge"),
                ForgeDataMod(mod_id="storagenetwork", mod_version="1.18.2-1.6.1"),
                ForgeDataMod(mod_id="framedcompactdrawers", mod_version="1.18-4.1.0"),
                ForgeDataMod(mod_id="decorative_blocks", mod_version="2.1.0"),
                ForgeDataMod(mod_id="botanypots", mod_version="8.0.12"),
                ForgeDataMod(mod_id="ftbbackups2", mod_version="1.0.17"),
                ForgeDataMod(mod_id="cofh_core", mod_version="1.6.4.21"),
                ForgeDataMod(mod_id="mcjtylib", mod_version="1.18-6.0.15"),
                ForgeDataMod(mod_id="ispawner", mod_version="1.0"),
                ForgeDataMod(mod_id="everycomp", mod_version="1.18.2-1.5.7"),
                ForgeDataMod(mod_id="jeitweaker", mod_version="3.0.0.8"),
                ForgeDataMod(mod_id="terralith", mod_version="0.0NONE"),
                ForgeDataMod(mod_id="mininggadgets", mod_version="1.11.0"),
                ForgeDataMod(mod_id="crafttweaker", mod_version="9.1.197"),
                ForgeDataMod(mod_id="akashictome", mod_version="1.5-20"),
                ForgeDataMod(mod_id="forge", mod_version="ANY"),
                ForgeDataMod(mod_id="colossalchests", mod_version="1.8.3"),
                ForgeDataMod(mod_id="selene", mod_version="1.18.2-1.17.9"),
                ForgeDataMod(mod_id="drippyloadingscreen", mod_version="1.6.4"),
                ForgeDataMod(
                    mod_id="craftingtweaks",
                    mod_version="<not required for client>",
                ),
                ForgeDataMod(mod_id="minecraft", mod_version="1.18.2"),
                ForgeDataMod(mod_id="terrablender", mod_version="1.18.2-1.1.0.102"),
                ForgeDataMod(
                    mod_id="sophisticatedbackpacksvh",
                    mod_version="1.18.2-1.0.4.12",
                ),
                ForgeDataMod(mod_id="mousetweaks", mod_version="ANY"),
                ForgeDataMod(mod_id="titanium", mod_version="3.5.6"),
                ForgeDataMod(mod_id="jade", mod_version="<not required for client>"),
                ForgeDataMod(mod_id="createtweaker", mod_version="2.0.0.17"),
                ForgeDataMod(mod_id="easy_villagers", mod_version="1.18.2-1.0.10"),
                ForgeDataMod(mod_id="pipez", mod_version="1.18.2-1.1.5"),
                ForgeDataMod(mod_id="iceberg", mod_version="ANY"),
                ForgeDataMod(mod_id="flywheel", mod_version="<not required for client>"),
                ForgeDataMod(mod_id="mantle", mod_version="1.9.27"),
                ForgeDataMod(mod_id="ecologics", mod_version="1.7.3"),
                ForgeDataMod(mod_id="quark", mod_version="3.2-358"),
                ForgeDataMod(mod_id="xaerominimap", mod_version="22.11.1"),
                ForgeDataMod(mod_id="pigpen", mod_version="8.0.1"),
                ForgeDataMod(mod_id="fastbench", mod_version="6.0.2"),
                ForgeDataMod(mod_id="polymorph", mod_version="1.18.2-0.44"),
                ForgeDataMod(mod_id="autoreglib", mod_version="1.7-53"),
                ForgeDataMod(mod_id="storagedrawers", mod_version="10.2.1"),
                ForgeDataMod(mod_id="fluxnetworks", mod_version="7.0.7.8"),
                ForgeDataMod(mod_id="neoncraft2", mod_version="2.2"),
                ForgeDataMod(mod_id="enercell", mod_version="0.0NONE"),
                ForgeDataMod(mod_id="appleskin", mod_version="2.4.0+mc1.18"),
                ForgeDataMod(
                    mod_id="ferritecore",
                    mod_version="<not required for client>",
                ),
                ForgeDataMod(mod_id="modularrouters", mod_version="9.1.1-93"),
                ForgeDataMod(mod_id="refinedstorageaddons", mod_version="0.8.2"),
                ForgeDataMod(mod_id="openloader", mod_version="12.0.1"),
                ForgeDataMod(mod_id="the_vault", mod_version="1.18.2-2.0.10.869"),
            ],
        ),
        ("truncated", False),
    ]
    ...
    EXPECTED_VALUES = [
        ...
        (
            ...
            ForgeData(
                ...
                channels=[],
                mods=[
                    ForgeDataMod(mod_id="minecraft", mod_version="1.12.2"),
                    ForgeDataMod(mod_id="mcp", mod_version="9.42"),
                    ForgeDataMod(mod_id="FML", mod_version="8.0.99.99"),
                    ForgeDataMod(mod_id="forge", mod_version="14.23.5.2859"),
                ],
                truncated=False,
            ),
        ),
    ...
    EXPECTED_VALUES = [
        ...
        (
            ...
            ForgeData(
                ...
                mods=[
                    ForgeDataMod(mod_id="minecraft", mod_version="1.20.1"),
                    ForgeDataMod(mod_id="forge", mod_version="ANY"),
                ],
                truncated=False,
            ),
