...
class TestJavaServer:
    ...
    def test_status(self):
        self.socket.receive(
            bytearray.fromhex(
                "6D006B7B226465736372697074696F6E223A2241204D696E65637261667420536572766572222C22706C6179657273223A7B226D61782"
                + "23A32302C226F6E6C696E65223A307D2C2276657273696F6E223A7B226E616D65223A22312E38222C2270726F746F636F6C223A3437"
                + "7D7D"
            )
        )
...
class TestLegacyServer:
    ...
    def test_status(self):
        self.socket.receive(
            bytearray.fromhex(
                "ff002300a7003100000034003700000031002e0034002e0032000000410020004d0069006e00650063007200610066007400200053006"
                + "5007200760065007200000030000000320030"
            )
        )
